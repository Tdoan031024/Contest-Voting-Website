    ...
    <>
      ...
      <main className="sc-908a50-0 iUzfqH flex-1">
        ...
        <div id="about-section" className="sc-1a037b37-0 ekqPrV relative mt-8 sm:mt-[60px]">
          <div className="pt-8 sm:pt-[40px] flex flex-col items-center">
            
            {/* Section Main Header Căn Giữa */}
            <div className="flex flex-col space-y-2 text-center mb-8 sm:mb-12">
            ...
            {/* 2 Columns Content */}
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 w-full px-4 sm:px-0">
              
              {/* Left Column: Information */}
              <div className="flex-1 flex flex-col space-y-4 sm:space-y-6 text-left">
                <h3 className="text-[20px] sm:text-[28px] font-bold uppercase text-black dark:text-neutral-white">
                  Về HUIT's Iconic 2024
                </h3>
                <p className="text-[14px] sm:text-[16px] text-neutral-neutral1/80 dark:text-neutral-white/80 leading-relaxed">
                  ...
                  Cuộc thi nhằm tôn vinh nét đẹp tri thức, phong cách tự tin, tài năng nổi bật cùng tinh thần trách nhiệm với cộng đồng của thế hệ trẻ HUIT. 
                  Đây là bệ phóng giúp các bạn sinh viên tỏa sáng, khẳng định bản thân và phát triển kỹ năng toàn diện trong thời đại mới.
                </p>
                <div>
                  <Link 
                    href="/the-le" 
                    className="group inline-flex items-center justify-center bg-gradient-to-r from-[#0A2FFF] to-[#79BCC2] text-white font-semibold rounded-full px-8 py-3.5 shadow-[0_4px_20px_rgba(10,47,255,0.25)] hover:shadow-[0_6px_24px_rgba(10,47,255,0.45)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 text-[14px] sm:text-[15px]"
                  >
                    <span>Đọc thêm</span>
                    <svg 
              ...
              <div className="flex-1 w-full relative">
                <div className="relative aspect-[4/3] sm:aspect-[16/10] overflow-hidden rounded-[24px] border border-white/10 shadow-xl group">
                  <img 
          ...
          <div className="sc-1a037b37-0 ekqPrV relative">
            <div className="pt-3 sm:pt-[85px] flex flex-col items-center">
              ...
              <div className="max-w-[615px] w-full mt-3 sm:mt-[64px]">
                <div className="flex items-center space-x-[8px] rounded-[20px] px-[8px] py-[7px] border border-grey-lightGrey1 dark:border-grey-darkGrey bg-grey-lightGrey2 dark:bg-grey-dimGrey h-[36px] sm:h-[60px] !px-2 rounded-[40px] w-full">
              ...
              <div className="flex flex-row justify-center items-center gap-4 sm:gap-6 mt-8 sm:mt-[48px] w-full">
                <Link 
                  href="/bang-xep-hang" 
                  className="flex items-center justify-center border border-white/20 hover:border-[#79BCC2] bg-white/5 hover:bg-white/10 text-white font-bold rounded-full px-6 py-3 sm:px-8 sm:py-3.5 transition-all duration-300 text-[12px] sm:text-[14px] uppercase tracking-wider shadow-lg hover:shadow-[#79BCC2]/10"
                >
                  Toàn bộ xếp hạng
                </Link>
                <Link 
        ...
        <div className="relative w-full max-w-[1440px] mx-auto pb-8 sm:pb-[85px]">
          <div className="pt-8 sm:pt-[85px] flex flex-col space-y-8 items-center">
