...
export default function LoginPage() {
  ...
  return (
    <div className="relative w-full min-h-[calc(100vh-60px-200px)] flex flex-col justify-center items-center py-16 sm:py-24 px-6 overflow-hidden">
      
      {/* Decorative mountain graphic at the bottom similar to original site theme */}
      ...
      <div className="w-full max-w-[900px] flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24 z-10 box-sizing-border-box">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-[360px] flex flex-col space-y-5">
          ...
          <button
            type="submit"
            className="w-full h-[46px] bg-[rgba(10,47,255,0.15)] hover:bg-[rgba(10,47,255,0.3)] border border-primary rounded-[12px] text-white font-semibold flex items-center justify-center transition-all text-[15px] tracking-wide"
          >
            Đăng nhập
          </button>
        </form>
        ...
        <div className="flex flex-row md:flex-col items-center justify-center gap-4">
          <div className="h-[1px] w-[60px] md:h-[50px] md:w-[1px] bg-white/20"></div>
        ...
        <div className="w-full max-w-[360px] flex flex-col items-center justify-center space-y-6">
          ...
          <button
            ...
            className="w-full max-w-[320px] flex items-center gap-4 p-3 rounded-[12px] bg-[rgba(10,47,255,0.15)] hover:bg-[rgba(10,47,255,0.25)] border border-primary transition-all text-left"
          >
