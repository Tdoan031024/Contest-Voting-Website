      ...
      <body className="bg-slate-900 text-slate-100 flex min-h-screen">
        ...
        <aside className="w-64 bg-slate-800 border-r border-slate-700 flex flex-col justify-between flex-shrink-0">
          <div className="flex flex-col">
            ...
            <div className="h-16 flex items-center px-6 border-b border-slate-700">
              <span className="font-extrabold text-[18px] tracking-wide text-blue-500">
                HUIT ICONIC ADMIN
              </span>
            </div>
            ...
            <nav className="flex flex-col p-4 space-y-1">
              <a href="/" className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-slate-700 transition-colors text-[14px] font-medium text-slate-200">
              ...
              <a href="/candidates" className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-slate-700 transition-colors text-[14px] font-medium text-slate-200">
              ...
              <a href="/sponsors" className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-slate-700 transition-colors text-[14px] font-medium text-slate-200">
              ...
              <a href="/settings" className="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-slate-700 transition-colors text-[14px] font-medium text-slate-200">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <header className="h-16 bg-slate-800 border-b border-slate-700 flex items-center justify-between px-8 flex-shrink-0">
            <h2 className="text-[16px] font-semibold text-slate-200 uppercase tracking-wider">
              Hệ thống Quản lý
            </h2>
